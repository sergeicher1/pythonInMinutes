...
MAX_POINTS = 50 # Initialize a constant for the max possible points
...
book = {
    ...
    "get_summary": lambda : "A novel about racism and injustice"
}
...
# 5. Loops
cities = ["New York", "Los Angeles", "Chicago"] # Alist of cities
for city in cities:
...
# 8. User Input
age = int(input("Enter your age: ")) # Ask the user to input the age
if age >= 18:
